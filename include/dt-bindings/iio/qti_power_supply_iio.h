...
#define PSY_IIO_UPDATE_NOW			0x80
#define PSY_IIO_CAPACITY_LEVEL			0x81
#define PSY_IIO_TIME_TO_EMPTY_NOW		0x82
#define PSY_IIO_STATUS				0x83
#define PSY_IIO_PRESENT				0x84
#define PSY_IIO_SC_FAULT_STATUS			0x85
#define PSY_IIO_SC_BATTERY_PRESENT 		0x86
#define PSY_IIO_SC_VBUS_PRESENT 		0x87
#define PSY_IIO_SC_BATTERY_VOLTAGE 		0x88
#define PSY_IIO_SC_BATTERY_CURRENT		0x89
#define PSY_IIO_SC_BATTERY_TEMPERATURE 		0x8a
#define PSY_IIO_SC_BUS_VOLTAGE			0x8b
#define PSY_IIO_SC_BUS_CURRENT			0x8c
#define PSY_IIO_SC_BUS_TEMPERATURE		0x8d
#define PSY_IIO_SC_DIE_TEMPERATURE		0x8e
#define PSY_IIO_SC_ALARM_STATUS			0x8f
#define PSY_IIO_SC_VBUS_ERROR_STATUS		 0x90
#define PSY_IIO_OTG_ENABLE			 0x91
#define PSY_IIO_MAIN_CHAGER_HZ			 0x92
#define PSY_IIO_MAIN_CHAGER_TERM		0x93
#define PSY_IIO_MAIN_CHAGER_CURRENT		0x94
#define PSY_IIO_BATTERY_VOLTAGE_TERM		0x95
#define PSY_IIO_BMS_CHIP_OK			0x96
#define PSY_IIO_BATTERY_AUTH			0x97
#define PSY_IIO_BMS_SOC_DECIMAL			0x98
#define PSY_IIO_BMS_SOC_DECIMAL_RATE		0x90
#define PSY_IIO_BATTERY_ID			0x9a

#define PSY_IIO_APDO_MAX_VOLT			0x100
#define PSY_IIO_APDO_MAX_CURR			0x101
#define PSY_IIO_SHUTDOWN_DELAY			0x102
#define PSY_IIO_FASTCHARGE_MODE			0x103
#define PSY_IIO_ENABLE_CHAGER_TERM		0x104
#define PSY_IIO_SC_ENABLE_ADC			0x105

#define PSY_IIO_MAIN_CHARGE_VBUS_ONLINE		0x106
#define PSY_IIO_WTCHG_UPDATE_WORK		0x107
#define PSY_IIO_WL_CHARGING_ENABLED		0x108
#define PSY_IIO_WL_CHARGING_FOD_UPDATE	0x109

#define PSY_IIO_MAIN_CHARGE_FEED_WDT	0x107

/* AFC  */
#define PSY_IIO_AFC_SET_VOL				0x10a
#define PSY_IIO_AFC_DETECT				0x10b
#define PSY_IIO_AFC_TYPE				0x10c
#define PSY_IIO_AFC_DETECH				0x10d
#define PSY_IIO_VBUS_VAL_NOW			0x10f

//+ReqP86801AA1-3595, liyiying.wt, add, 20230801, Configure SEC_BAT_CURRENT_EVENT_HV_DISABLE
#define PSY_IIO_HV_DISABLE_DETECT		0x110
#define PSY_IIO_CHARGE_PG_STAT			0x111
//-ReqP86801AA1-3595, liyiying.wt, add, 20230801, Configure SEC_BAT_CURRENT_EVENT_HV_DISABLE

#define PSY_IIO_PD_INPUT_SUSPEND		0x112
